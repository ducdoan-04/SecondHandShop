...
import com.example.secondhandshop.databinding.ItemListUpdateProductBinding
...
class ListUpdateProductShopAdapter: RecyclerView.Adapter<ListUpdateProductShopAdapter.ListUpdateProductViewHolder>() {

    inner class ListUpdateProductViewHolder(val binding: ItemListUpdateProductBinding):
...
//                tvSearchProductQuantity.text = "0"
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListUpdateProductViewHolder {
        return ListUpdateProductViewHolder(
            ItemListUpdateProductBinding.inflate(
    ...
    override fun onBindViewHolder(holder: ListUpdateProductViewHolder, position: Int) {
       val viewProfileProductShop = differ.currentList[position]
        ...
        holder.binding.imageUpdateProduct.setOnClickListener {
            onUpdateClick?.invoke(viewProfileProductShop)
        }
    }
